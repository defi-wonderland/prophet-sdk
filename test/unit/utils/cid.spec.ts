...
import { cidToBytes32, bytes32ToCid, isIpfsUri, isIpfsCID } from '../../../src/utils/cid';
...
describe('Cid', () => {
  describe('cidToBytes32', () => {
    ...
    it('should handle different input CID formats', () => {
      ...
      const expected2Bytes32 = '0x' + decode(anotherCid).slice(2).toString('hex');
  ...
  describe('bytes32ToCid', () => {
    it('should convert bytes32 to IPFS CID', () => {
      // Arrange
      const bytes32 = '0x4b47917f1b61e5395a767c7a9427aa695f5568cf7a7f259b92f468f8fcc4fbd2'; // Bytes32 QmABCDEFGHJKLMNPQRSTUVWXYZabcdefghijkmnopqrstuvwxyz
